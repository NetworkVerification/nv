...
let rec alpha_rename_smt_term
    (renaming : string StringMap.t)
    (valMap : smt_term StringMap.t)
    (tm : smt_term)
  =
  match tm with
  ...
  | Or (tm1, tm2) ->
    mk_or_fast
      (alpha_rename_smt_term renaming valMap tm1)
      (alpha_rename_smt_term renaming valMap tm2)
  | Not tm1 -> mk_not_fast (alpha_rename_smt_term renaming valMap tm1)
  | BvAdd (tm1, tm2) ->
    BvAdd
      ( alpha_rename_smt_term renaming valMap tm1
      , alpha_rename_smt_term renaming valMap tm2 )
  ...
  | IntToBv (tm1, sz) -> IntToBv (alpha_rename_smt_term renaming valMap tm1, sz)
  | BvToInt (tm1, sz) -> BvToInt (alpha_rename_smt_term renaming valMap tm1, sz)
  | AtMost (tm1, tm2, tm3) ->
    AtMost
      ( BatList.map (alpha_rename_smt_term renaming valMap) tm1
      , tm2
      , alpha_rename_smt_term renaming valMap tm3 )
  | Var s ->
    let sr =
