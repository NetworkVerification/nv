...
let make_toplevel (rtys : ty StringMap.t list) (toplevel_mutator : 'a Mutators.toplevel_mutator) =
  toplevel_mutator ~name:"RecordUnrolling" ty_mutator pattern_mutator
    value_mutator (exp_mutator rtys) map_back_mutator mask_mutator
...
let unroll_net net =
  ...
  make_toplevel rtys Mutators.mutate_network net
